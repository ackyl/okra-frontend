      ...
      return(
        <div style={{...styles.root}}>
            <Toolbar style={{...styles.bg}}>
              ...
              <Link to='/trans' style={{color: '#000000'}}><Button color="inherit">Transactions</Button></Link>
      ...
      return(
        <div style={{...styles.root}}>
            <Toolbar style={{...styles.bg}}>
              ...
              <Link to='/trans' style={{color: '#000000'}}><Button color="inherit">Verify</Button></Link>
              <Link to='/alltrans' style={{color: '#000000'}}><Button color="inherit">User Transactions</Button></Link>
              <Button color="inherit" onClick={this.onClickLogout} style={{color: '#000000'}}>Logout</Button>
